...
export default async function handler(req, res) {
    ...
    try {
        ...
        const finalPrompt = `
                ...
                - Append "_1058" to the end of source code filenames, right before the file extension (e.g., "App_1058.tsx", "server_1058.js", "Navbar_1058.jsx", "socket_1058.ts")
                - STRICTLY Do NOT append "_1058" to dependency, configuration, or entry HTML files (must be exactly "package.json", "tsconfig.json", "vite.config.ts", "index.html", ".gitignore")
                - CRITICAL: Ensure all import/require statements inside the generated code perfectly match the newly appended "_1058" filenames.
